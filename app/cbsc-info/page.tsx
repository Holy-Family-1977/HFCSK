...
function GeneralInformation({
  ...
  const generalInfo = [
    ...
    { sl: 5, info: 'PRINCIPAL NAME & QUALIFICATION', details: 'SR. BENSY V K (M.A,B.Ed.)' },
...
function StaffTeaching() {
  const staffData = [
    ...
    { dept: 'PGT', sn: 7, name: 'Mrs. Panchami S.J', designation: 'PGT', qualification: 'M.A, B.Ed' },
    { dept: 'PGT', sn: 8, name:  'Mr.Ronald James', designation: 'PGT', qualification: 'MPES' },
    { dept: 'PGT', sn: 9, name:  'Ms. Anshika Shrivastava', designation: 'PGT', qualification: 'M.Com, B.Ed, PGDCA' },
    { dept: 'PGT', sn: 10, name: 'Mrs.Suma V K', designation: 'PGT', qualification: 'M.A., B.Ed.' },
    { dept: 'PGT', sn: 11, name: 'Miss. Chinchina M.J', designation: 'PGT', qualification: 'M.Sc., B.Ed.' },
    ...
    { dept: 'PGT', sn: 14, name: 'Mr. Ritesh Lodhi', designation: 'PGT', qualification: 'MPED.' },
    ...
    { dept: 'TGT', sn: 12, name: 'Mrs. Sapna Vishwakrma', designation: 'TGT', qualification: 'M.A, B.Ed' },
    { dept: 'TGT', sn: 13, name: 'Ms. Neelima Antoy', designation: 'TGT', qualification: 'BSc. B.Ed' },
    ...
    { dept: 'TGT', sn: 18, name: 'Mrs.Helen Dora', designation: 'TGT', qualification: 'B.A., B.Ed.' },
    { dept: 'TGT', sn: 19, name: 'Ms. Amulya Nirmal Arakkal', designation: 'TGT', qualification: 'M.A., B.Ed.' },
    { dept: 'TGT', sn: 20, name: 'Ms. Rose Mathew ', designation: 'TGT', qualification: 'M.A., B.Ed.' },
    { dept: 'TGT', sn: 21, name: 'Joti (Sr. Deepika)', designation: 'TGT', qualification: 'B.A., B.Lib.' },
    { dept: 'TGT', sn: 22, name: 'Mr. Sourabh Jain', designation: 'TGT', qualification: 'M.A., B.Ed.' },
    ...
    { dept: 'PRT', sn: 15, name: 'Ms.Shweta Nisee Lakra', designation: 'PRT', qualification: 'M.SW.' },
    ...
    { dept: 'PRT', sn: 20, name: 'Mrs. Ayushi Patkar', designation: 'PRT', qualification: 'M.Sc, B.Ed.' },
    { dept: 'PRT', sn: 21, name: 'Miss Tanu Sahu', designation: 'PRT', qualification: 'MBA, B.Ed.' },
    { dept: 'PRT', sn: 22, name: 'Ms.Sakshi Jain ', designation: 'PRT', qualification: 'B.Sc., B.Ed.' },
     // PRRT
    { dept: 'PRT', sn: 1, name: 'Mrs. Varsha Choubey', designation: 'PPRT', qualification: 'B.A,NPTT,B.E' },
    { dept: 'PRT', sn: 2, name: 'Mrs. Prachi Shrivastava', designation: 'PRRT', qualification: 'M.Com.' },
    { dept: 'PRT', sn: 3, name: 'Mrs. Namrta Jain', designation: 'PPRT', qualification: 'M.A , (PDL,NTT)' },
    { dept: 'PRT', sn: 4, name: 'Ms.Palak Agrawal', designation: 'PPRT', qualification: 'M.Com, DSA, B.Ed' },
    { dept: 'PRT', sn: 5, name: 'Ms. Rishika Kori', designation: 'PPRT', qualification: 'M.Com, DSA, B.Ed' },
    { dept: 'PRT', sn: 6, name: 'Ms. Deepti Ekka', designation: 'PPRT', qualification: 'B.Com B.Ed' },
    { dept: 'PRT', sn: 7, name: 'Ms.Simran Mary', designation: 'PRRT', qualification: 'B.Com, B.E.d' },
    { dept: 'PRT', sn: 8, name: 'Ms.Kashish Hinduja', designation: 'PPRT', qualification: 'B.B.A , B.Ed' },
    { dept: 'PRT', sn: 9, name: 'Ms.Dayamani Kertetta', designation: 'PPRT', qualification: 'BPA' },
    { dept: 'PRT', sn: 10, name: 'Ms. Mahak Jain', designation: 'PPRT', qualification: 'M.Com, B.Edu' },
    { dept: 'PRT', sn: 11, name: 'Ms.Vaishali Hinduja', designation: 'PPRT', qualification: 'B.Com,NTT' },
    { dept: 'PRT', sn: 12, name: 'Ms. Esha Sukhwani', designation: 'PPRT', qualification: 'B.Com, B.Ed' },
  ]
